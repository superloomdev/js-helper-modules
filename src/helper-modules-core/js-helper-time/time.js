...
const createInterface = function (Lib, CONFIG, ERRORS, Validators) { // eslint-disable-line no-unused-vars
  ...
  const Time = { // Public functions accessible by other modules
    ...
    *********************************************************************/
    formatDayName: function (year, month, day) {
    ...
    *********************************************************************/
    buildEpochDay: function (hours, minutes, seconds) {
    ...
    Inverse of buildEpochDay().

    @param {Integer} day_in_seconds - Seconds in a day (0-86400)

    @return {Array} - [hours, minutes, seconds]
    *********************************************************************/
    disjoinEpochDay: function (day_in_seconds) {
    ...
    *********************************************************************/
    parseUnixtimeToDate: function (unixtime) {
    ...
    *********************************************************************/
    buildUnixtimeFromDate: function (date) {
    ...
    *********************************************************************/
    formatUnixtimeToDateString: function (unixtime) {

      return Time.parseUnixtimeToDate(unixtime).toISOString();
    ...
    *********************************************************************/
    parseDateStringToUnixtime: function (date_string) {
    ...
    *********************************************************************/
    formatUnixtimeToUtcString: function (unixtime) {

      return Time.parseUnixtimeToDate(unixtime).toUTCString();
    ...
    @return {Integer} - Seconds since Unix epoch
    *********************************************************************/
    parseUtcStringToUnixtime: function (date_string) {

      return Time.buildUnixtimeFromDate(new Date(date_string));
    ...
    *********************************************************************/
    buildUnixDay: function (unixtime) {
    ...
    //
    // Note the two shape variants: buildDateDataSet()/buildDateFromDateDataSet() use
    // plural keys (hours, minutes, seconds) - this is the "build" shape.
    // parseDateStringToDataSet()/buildDataSetFromDate() return singular keys (hour,
    ...
    *********************************************************************/
    buildDateDataSet: function (year, month, day, hours, minutes, seconds) {
    ...
    *********************************************************************/
    parseDateStringToDataSet: function (date_string) {
    ...
    Delegates to parseDateStringToDataSet via ISO serialization.

    @param {Date} date - Date object

    @return {Object} - { year, month, day, hour, minute, second }
    *********************************************************************/
    buildDataSetFromDate: function (date) {

      return Time.parseDateStringToDataSet(date.toISOString());
    ...
    *********************************************************************/
    buildDateFromDateDataSet: function (date_data) {
    ...
    *********************************************************************/
    formatDateDataSetToDateString: function (date_data) {

      return Time.buildDateFromDateDataSet(date_data).toISOString();
    ...
    @return {Integer} - Seconds since Unix epoch
    *********************************************************************/
    buildUnixtimeFromDateDataSet: function (date_data) {

      return Time.buildUnixtimeFromDate(
        Time.buildDateFromDateDataSet(date_data)
      );
    ...
    *********************************************************************/
    formatSeconds: function (seconds) {
      ...
      const date_string = Time.formatUnixtimeToDateString(seconds);
      const date_data = Time.parseDateStringToDataSet(date_string);
    ...
    helper used by buildTimezoneTime and callers doing manual
    offset math.
    ...
    *********************************************************************/
    buildTimeWithOffset: function (unixtime, offset) {
    ...
    *********************************************************************/
    buildTimezoneTime: function (unixtime, timezone) {

      return Time.buildTimeWithOffset(
        unixtime,
    ...
    *********************************************************************/
    buildTimezoneDate: function (unixtime, timezone) {

      return new Date(
        Time.buildTimezoneTime(unixtime, timezone) * 1000
      );
    ...
    *********************************************************************/
    getLastDayOfMonth: function (year, month) {
      ...
      const date_set = Time.buildDateDataSet(
        year,
        Number(month) + 1,
        0
      );

      const date = Time.buildDateFromDateDataSet(date_set);

      return Time.buildDataSetFromDate(date).day;
