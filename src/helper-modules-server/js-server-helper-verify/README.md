...
It expects three peer modules in the `Lib` container (Utils, Debug, Instance) and one optional peer adapter package for your storage backend. For the full dependency breakdown, see [`docs/configuration.md`](docs/configuration.md).
