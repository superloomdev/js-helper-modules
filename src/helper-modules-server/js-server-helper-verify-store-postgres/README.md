...
The adapter cannot stand alone. It is always loaded together with the Verify parent and the [`helper-sql-postgres`](https://github.com/superloomdev/superloom/tree/main/src/helper-modules-server/js-server-helper-sql-postgres) driver helper.
