...
Lib.S3UrlSigner = storageAwsS3UrlSigner(Lib, {
...
You should never import `@aws-sdk/client-s3` or `@aws-sdk/s3-request-presigner` in your application code. The module exists to wrap them.
...
Lib.PrimarySigner = storageAwsS3UrlSigner(Lib, {
  REGION: 'us-east-1',
  KEY:    process.env.PRIMARY_AWS_KEY,
  SECRET: process.env.PRIMARY_AWS_SECRET
});

Lib.BackupSigner = storageAwsS3UrlSigner(Lib, {
  REGION: 'eu-west-1',
