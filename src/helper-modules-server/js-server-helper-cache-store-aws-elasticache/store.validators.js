// Info: Config validator for helper-cache-store-aws-elasticache.
  ...
  *********************************************************************/
  validateConfig: function (config) {
    ...
    if (
      ...
      throw new Error('[helper-cache-store-aws-elasticache] config.KEY_PREFIX is required (non-empty string)');
    }
    ...
    if (
      ...
      throw new Error('[helper-cache-store-aws-elasticache] config.KEY_SEPARATOR is required (non-empty string)');
    }
    ...
    if (
      ...
      throw new Error('[helper-cache-store-aws-elasticache] config.LOCK_KEY_PREFIX is required (non-empty string)');
    }
