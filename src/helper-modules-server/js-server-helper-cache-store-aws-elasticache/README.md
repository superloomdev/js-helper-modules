...
The adapter cannot stand alone. It is always loaded together with the Cache parent and the [`helper-kv-aws-elasticache`](https://github.com/superloomdev/js-helper-modules/tree/main/src/helper-modules-server/js-server-helper-kv-aws-elasticache) driver helper.
...
| Tier | Runtime | Status |
|---|---|---|
| Contract + Integration | ElastiCache via Docker Compose (Valkey stand-in) | [![Test](https://github.com/superloomdev/js-helper-modules/actions/workflows/ci-publish-helper-modules.yml/badge.svg?branch=main)](https://github.com/superloomdev/js-helper-modules/actions/workflows/ci-publish-helper-modules.yml) |
