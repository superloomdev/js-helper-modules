...
|---|---|---|---|---|
| `Store` | `object` | `null` | Yes | Ready-to-use store object. Construct the adapter first: `require('@superloomdev/js-server-helper-logger-store-<backend>')({ ... })`. Loader throws on missing or non-object |
