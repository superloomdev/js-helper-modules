    ...
    commandUploadObject: async function (instance, service_params) {
      ...
      try {
        ...
        return {
          success: false,
          etag: null,
          error: ERRORS.STORAGE_UPLOAD_FAILED
        };
    ...
    commandGetObject: async function (instance, service_params, output_as_string) {
      ...
      try {
        ...
        if (error.name !== 'NoSuchKey' && error.name !== 'NotFound') {
          Lib.Debug.debug('S3 GetObject failed', {
            type: ERRORS.STORAGE_DOWNLOAD_FAILED.type,
            bucket: service_params.Bucket,
            key: service_params.Key,
            message: error.message,
            code: error.code || null,
        ...
        return {
          ...
          content_type: null,
          metadata: null,
          error: error.name === 'NoSuchKey' ? ERRORS.STORAGE_NOT_FOUND : ERRORS.STORAGE_DOWNLOAD_FAILED
        };
    ...
    *********************************************************************/
    commandCopyObject: async function (instance, service_params) {
      ...
      try {
        ...
        // Suppress log noise for expected "object not found" errors
        if (error.name !== 'NoSuchKey' && error.name !== 'NotFound') {
          Lib.Debug.debug('S3 CopyObject failed', {
            type: ERRORS.STORAGE_COPY_FAILED.type,
            bucket: service_params.Bucket,
            key: service_params.Key,
            message: error.message,
            code: error.code || null,
        ...
        return {
          success: false,
          error: error.name === 'NoSuchKey' ? ERRORS.STORAGE_NOT_FOUND : ERRORS.STORAGE_COPY_FAILED
        };
    ...
    listObjects: async function (instance, bucket, prefix) {
      ...
      try {
        ...
        return {
          success: false,
          keys: [],
          error: ERRORS.STORAGE_LIST_FAILED
        };
    ...
    uploadFiles: async function (instance, files) {
      ...
      try {
        ...
        return {
          success: false,
          results: [],
          error: ERRORS.STORAGE_BATCH_UPLOAD_FAILED
        };
    ...
    deleteFiles: async function (instance, bucket, keys) {
      ...
      try {
        ...
        return {
          success: false,
          deleted: [],
          error: ERRORS.STORAGE_BATCH_DELETE_FAILED
        };
