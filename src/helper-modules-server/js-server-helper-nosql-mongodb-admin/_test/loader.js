...
Instance process cleanup queue and its own MongoDBAdmin driver state.
...
export default function loader () {
  ...
  // and an independent MongoDBAdmin driver (own client state).
  const buildLib = function (instance_config) {
    ...
    Lib.MongoDBAdmin = mongodbAdminLoader(Lib, config_mongodb_admin);
