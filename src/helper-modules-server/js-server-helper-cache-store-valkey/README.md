...
The adapter cannot stand alone. It is always loaded together with the Cache parent and the [`helper-kv-valkey`](https://github.com/superloomdev/superloom/tree/main/src/helper-modules-server/js-server-helper-kv-valkey) driver helper.
...
| Tier | Runtime | Status |
|---|---|---|
| Contract + Integration | Valkey via Docker Compose | [![Test](https://github.com/superloomdev/superloom/actions/workflows/ci-helper-modules.yml/badge.svg?branch=main)](https://github.com/superloomdev/superloom/actions/workflows/ci-helper-modules.yml) |
