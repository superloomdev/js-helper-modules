    ...
    commandAddRecord: async function (instance, service_params) {
      ...
      try {
        ...
        Lib.Debug.debug('DynamoDB writeRecord failed', {
          ...
          table: service_params.TableName,
    ...
    scan: async function (instance, table, filter) {
      ...
      try {
        ...
        return {
          ...
          items: [],
          count: 0,
          error: ERRORS.DATABASE_SCAN_FAILED
        };
    ...
    batchGetRecords: async function (instance, keysByTable) {
      ...
      try {
        ...
        return {
          success: false,
          items: {},
          error: ERRORS.DATABASE_BATCH_FAILED
        };
    ...
    *********************************************************************/
    createTable: async function (instance, table, params) {
      ...
      try {
        ...
        Lib.Debug.debug('DynamoDB createTable failed', {
          type: ERRORS.DATABASE_TABLE_CREATE_FAILED.type,
          table: table,
          message: error.message,
          code: error.code || null,
          stack: error.stack
        ...
        return {
          ...
          error: ERRORS.DATABASE_TABLE_CREATE_FAILED
        };
    ...
    *********************************************************************/
    deleteTable: async function (instance, table) {
      ...
      try {
        ...
        Lib.Debug.debug('DynamoDB deleteTable failed', {
          type: ERRORS.DATABASE_TABLE_DELETE_FAILED.type,
          table: table,
          message: error.message,
          code: error.code || null,
          stack: error.stack
        ...
        return {
          ...
          error: ERRORS.DATABASE_TABLE_DELETE_FAILED
        };
