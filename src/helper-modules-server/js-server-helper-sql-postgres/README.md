...
- **`pg`** (node-postgres). PostgreSQL client with connection pooling. Used because the PostgreSQL frontend/backend protocol is proprietary and the driver encodes SSL handling and auth negotiation that cannot be reimplemented in-house
...
| Tier | Runtime | Status |
|---|---|---|
| Emulated | Postgres 17 in Docker | [![Test](https://github.com/superloomdev/js-helper-modules/actions/workflows/ci-publish-helper-modules.yml/badge.svg?branch=main)](https://github.com/superloomdev/js-helper-modules/actions/workflows/ci-publish-helper-modules.yml) |
