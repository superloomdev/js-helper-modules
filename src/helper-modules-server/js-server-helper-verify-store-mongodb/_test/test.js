...
const TEST_COLLECTION = 'verify_codes';
...
describe('Tier 1: getRecord not-found path', function () {
  ...
  it('returns success:true with null record when the document does not exist', async function () {
...
describe('Tier 1: deleteRecord', function () {
  ...
  it('deleteRecord removes the document', async function () {
  ...
  it('deleteRecord on a missing document is a no-op (success)', async function () {
...
describe('Tier 1: cleanupExpiredRecords accuracy', function () {
  ...
  it('deletes only documents with expires_at < now and reports accurate deleted_count', async function () {
