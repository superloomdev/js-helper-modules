// Info: React Native Web extension for js-client-helper-styler.
//
...
const Extension = { // Public React bindings accessible by the host
  ...
  @param {Object} props.template - template to fill (defaults to Lib.Styler.template)
  ...
  *********************************************************************/
  ThemeProvider: function (props) {
    ...
    const template = props.template || Lib.Styler.template;
